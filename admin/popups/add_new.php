			...
			<div id="post-body-content" style="position: relative;">
				<div id="titlediv">
					<div id="titlewrap">
						...
						<input type="text" name="title" size="30" value="<?php echo $title; ?>" id="title" placeholder="<?php _e( 'Register a popup name', 'leadgeneration' ); ?>">
					...
					<div class="inside">					
						<div class="lg-container">
							<div class="lg-element">								
								...
								<?php if ($act == "update") : ; ?>								
								<span class="preview button open-popup"><?php _e('Preview', 'leadgeneration'); ?></span>
								<em><?php _e('You can preview the changed settings after the click "Update".','leadgeneration'); ?></em>
								<?php endif; ?>
							</div>
						</div>
					...
					<div class="inside">
						<div class="tab-box">
							<ul class="tab-nav">
								<?php 
									$tab_menu = array(
									'popup'      => __( 'Popup Settings', 'leadgeneration' ),
									'close'      => __( 'Close Settings', 'leadgeneration' ),									
									'style'      => __( 'Popup Style', 'leadgeneration' ),
									'stylebtn'   => __( 'Close Button Style ', 'leadgeneration' ),															
									);						
									$i = 1;

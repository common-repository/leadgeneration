...
<div class="wrap">
	<h1 class="wp-heading-inline"><?php _e( 'Forms', 'leadgeneration' ); ?></h1>
	<a href="?page=<?php echo $toolpage; ?>&tab=add_new" class="page-title-action">Add New</a>

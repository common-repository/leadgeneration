...
<div class="lg-container">
	<div class="lg-element">
		<?php echo apply_filters( 'lg_create_option', $overlay ); ?><label for="lg_overlay"><?php _e('Overlay', 'leadgeneration'); ?></label><?php echo apply_filters( 'lg_help_tip', $overlay_help ); ?><br/>
	...
	<div class="lg-element">		
		<label><?php _e('Position', 'leadgeneration'); ?></label><?php echo apply_filters( 'lg_help_tip', $position_help ); ?><br/>
...
<div class="lg-container">	
	<div class="lg-element">
		<label><?php _e('Background Image URL', 'leadgeneration'); ?></label><?php echo apply_filters( 'lg_help_tip', $background_image_help ); ?><br/>
...
<fieldset id="lg-popup-title">
	...
	<div class="lg-container">
		...
		<div class="lg-element">
			<label><?php _e('Line Height', 'leadgeneration'); ?></label><?php echo apply_filters( 'lg_help_tip', $title_line_height_help ); ?><br/>
...
<fieldset id="lg-popup-title">
	<legend><?php _e('Content', 'leadgeneration'); ?></legend>
	
	<div class="lg-container">
		<div class="lg-element">
			<label><?php _e('Font Size', 'leadgeneration'); ?></label><br/>

<?php if ( ! defined( 'ABSPATH' ) ) exit;
	...
	*/
	...
	$option_name_view = '_lg_tool_button_view_counter_' . $tool_id;
	$option_name_action = '_lg_tool_button_action_counter_' . $tool_id;
...
<div id="lg-analytics" class="postbox lg-sidebar">
	...
	<div class="lg-container">
		<div class="lg-element">			
			...
			<span class="dashicons dashicons-external"></span> <?php _e('Actions', 'leadgeneration'); ?> - <span id="tool_action"><?php echo $tool_action; ?></span><p/>
			...
			<span class="preview button" onclick="reset_counts('button', <?php echo $tool_id; ?>);"><?php _e('Reset', 'leadgeneration'); ?></span>					
		</div>		
	</div>
	</div>
</div>
...
<div id="lg-targeting" class="postbox lg-sidebar">
	...
	<div class="inside">				
		...
		<?php if( class_exists( 'LG_Buttons_Targeting' ) ) {
			...
			printf( __( '<a href="%s" target="_blank">More advanced targeting</a>','leadgeneration' ), esc_url( 'https://wow-estore.com/lead-generation/#pro' ) );
		}

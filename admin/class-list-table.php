		...
		private function table_data()
		{
			...
			if ($resultat) {				
				foreach ($resultat as $key => $value) {					
					$data[] = array(
					'ID' => $value->id,	
					'title'  => '<a href="admin.php?page='.$this->toolpage.'&tab=add_new&act=update&id='.$value->id.'">'.$value->title.'</a>',
					'code'  => '['.$this->shortcode.' id="'.$value->id.'"]',					
					'edit' => '<a href="admin.php?page='.$this->toolpage.'&tab=add_new&act=update&id='.$value->id.'">edit</a>',
					'delete' => '<a href="admin.php?page='.$this->toolpage.'&info=delete&did='.$value->id.'" style="color:red;">delete</a>',
					'duplicate' => '<a href="admin.php?page='.$this->toolpage.'&tab=add_new&act=duplicate&id='.$value->id.'" style="color:green;">duplicate</a>',					
					);				
				}	
			}
			return $data;	

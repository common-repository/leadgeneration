<?php if ( ! defined( 'ABSPATH' ) ) exit;
	...
	*/
	...
	wp_enqueue_style( 'lg-main', WPLG_PLUGIN_URL . 'assets/css/main.css', array(), '1.0' );
	wp_enqueue_style( 'lg-animate', WPLG_PLUGIN_URL . 'assets/css/animate.css', array(), '1.0' );	
	wp_enqueue_script( 'lg-popups', WPLG_PLUGIN_URL . 'assets/js/popups/jquery.popup.js', array( 'jquery' ), '1.0' );
	echo '<style>';
